    ...
    <PageShell variants={{ heightFull: 'max' }}>
      <div className='flex items-center justify-between px-4 py-2'>
        <div className='flex items-center gap-1'>
          ...
          <title>{LL.lyricsSyncer.title()}</title>
          <h1 className='text-text-important text-lg font-bold tracking-wide'>{LL.lyricsSyncer.title()}</h1>
        </div>
      </div>
